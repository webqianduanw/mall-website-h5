  ...
  <div class="index">
    <div class="header" ref="header" style="display:none;">
      <div class="header-box clearfix">
        <div class="fleft header-box-left" @click="jumpClick(1)">
          ...
          <div class="app-name fleft">贝福优选</div>
        </div>
      ...
      <div class="content3">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <img src="../assets/img/index/swiper2.png" alt="">
                </div>
                 <div class="swiper-slide">
        ...
        <div class="content9_cont">
          <div class="content9_cont_left">
            ...
            <div class="content9_cont_left_txt2">
              地址：惠州市惠城区河南岸螺子湖南街公园1号物联网孵化基地4楼Hec735
            </div>
    ...
    <div class="footer">
      <div class="footer_cont">
        <a href="http://beian.miit.gov.cn/?spm=a2c4g.11186623.7y9jhqsfz.111.26b47243MaN2zM" target="_blank" data-spm-anchor-id="a2c4g.11186623.7y9jhqsfz.111">粤ICP备2021121729号</a>
              http://www.walnutsgame.com @ 2021 贝福优选所有
      </div>
    </div>
  </div>
</template>
...
.content9{
  ...
  .content9_cont{
    ...
    .content9_cont_left{
      float: left;
      .content9_cont_left_txt1{
        margin-top: 90px;
        font-size: 18px;
        color: #FFFFFF;
      }
      .content9_cont_left_txt2{
        margin-top: 14px;
        font-size: 18px;
        color: #FFFFFF;
      }
      .content9_cont_left_txt3{
        margin-top: 14px;
        font-size: 18px;
        color: #FFFFFF;
      }
